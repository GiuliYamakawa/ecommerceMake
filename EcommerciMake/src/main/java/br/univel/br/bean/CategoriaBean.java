...
public class CategoriaBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         Iterator<Produto> iterProdutos = deletableEntity.getProdutos().iterator();
         for (; iterProdutos.hasNext();)
         {
            Produto nextInProdutos = iterProdutos.next();
            nextInProdutos.setCategoria(null);
            iterProdutos.remove();
            this.entityManager.merge(nextInProdutos);
         }
